...
- ENABLE_DB_VIEWER defaults to false. Even if set true, the DB container will not attempt to run Node; viewer must be launched manually elsewhere after npm install succeeds.
